...
/obj/effect/sign/hatch
	name = "hatch"
	desc = "Там точно кто-то есть."
	icon = 'decals.dmi'
	icon_state = "hatch"

/obj/effect/sign/ai_frame
	name = "AI display"
	desc = "Что случилось с ИИ?"
	icon = 'decals.dmi'
	icon_state = "ai_frame"
...
/obj/item/stack/tile/steel
	...
	desc = "Those could work as a pretty decent throwinging weapon"
	icon_state = "tile"
	w_class = 3.0
	force = 6.0
	m_amt = 937.5
...
/obj/item/weapon/beach_ball
	...
	afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
		user.drop_item()
		src.throwing_at(target, throwing_range, throwing_speed)
