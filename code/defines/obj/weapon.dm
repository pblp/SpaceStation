...
/obj/item/weapon/melee/energy/blade
	...
	throwingforce = 1//throwinging or dropping the item deletes it.
	throwing_speed = 1
	throwing_range = 1
...
/obj/item/weapon/paper/doors
	name = "paper- 'Reminder'"
	info = "Добрый день, капитан. Мы забыли предупредить вас, двери неисправны и могут иногда искрить, будьте аккуратны и скажите об этом остальному экипажу. <B>NT :*</B>"
...
/obj/item/weapon/shard
	...
	icon = 'shards.dmi'
	icon_state = "large"
	desc = "Could probably be used as ... a throwinging weapon?"
	w_class = 1.0
	force = 5.0
	throwingforce = 15.0
