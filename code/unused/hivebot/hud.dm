...
//Module Panel
	...
	using.screen_loc = ui_throwing
	using.layer = 19
	src.adding += using

//Store
	mymob.throwing_icon = new /obj/screen(null)
	mymob.throwing_icon.icon = 'screen1_robot.dmi'
	mymob.throwing_icon.icon_state = "store"
	mymob.throwing_icon.name = "store"
	mymob.throwing_icon.screen_loc = ui_hand
...
//does nothing (fire and oxy)
	...
	mymob.client.screen += list(mymob.throwing_icon, mymob.zone_sel, mymob.oxygen, mymob.fire, mymob.hands, mymob.healths, mymob:cells, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
