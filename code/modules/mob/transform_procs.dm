...
/mob/living/carbon/human/proc/Robotize()
	...
	if(client)
		...
		client.screen -= list( oxygen, throwing_icon, i_select, m_select, toxin, internals, fire, hands, healths, pullin, blind, flash, rest, sleep, mach )
		client.screen -= list( zone_sel, oxygen, throwing_icon, i_select, m_select, toxin, internals, fire, hands, healths, pullin, blind, flash, rest, sleep, mach )
