...
*/
	...
	mymob.throwing_icon = new /obj/screen(null)
	mymob.throwing_icon.icon = ui_style
	mymob.throwing_icon.icon_state = "act_throwing_off"
	mymob.throwing_icon.name = "throwing"
	mymob.throwing_icon.screen_loc = ui_throwing
...
*/
	...
	mymob.client.screen += list( mymob.throwing_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.hands, mymob.healths, mymob.nutrition_icon, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
