/mob/living/carbon/alien/humanoid/Login()
	...
	return
	/*
	src.throwing_icon = new /obj/screen(null)
	...
	src.throwing_icon.name = "throwing"
	...
	src.throwing_icon.screen_loc = "9,1"
	...
	src.client.screen -= list( src.throwing_icon, src.zone_sel, src.oxygen, src.i_select, src.m_select, src.toxin, src.bodytemp, src.internals, src.fire, src.hands, src.healths, src.pullin, src.blind, src.flash, src.rest, src.sleep, src.mach )
	src.client.screen += list( src.throwing_icon, src.zone_sel, src.oxygen, src.i_select, src.m_select, src.toxin, src.bodytemp, src.internals, src.fire, src.hands, src.healths, src.pullin, src.blind, src.flash, src.rest, src.sleep, src.mach )
