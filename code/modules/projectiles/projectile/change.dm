		...
		switch(randomize)
			...
			if("robot")
				...
				if(M.client)
					...
					M.client.screen -= list( M.oxygen, M.throwing_icon, M.i_select, M.m_select, M.toxin, M.internals, M.fire, M.hands, M.healths, M.pullin, M.blind, M.flash, M.rest, M.sleep, M.mach )
					M.client.screen -= list( M.zone_sel, M.oxygen, M.throwing_icon, M.i_select, M.m_select, M.toxin, M.internals, M.fire, M.hands, M.healths, M.pullin, M.blind, M.flash, M.rest, M.sleep, M.mach )
