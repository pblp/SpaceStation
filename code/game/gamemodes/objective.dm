...
datum/objective/assassinate
	find_target()
		...
		if(target && target.current)
			explanation_text = "Убей [target.current.real_name], не дай ему помешать твоим цел&#255;м."
		else
			explanation_text = "Ты свободен."
		return target
...
datum/objective/debrain//I want braaaainssss
	find_target()
		..()
		if(target && target.current)
			explanation_text = "Похить мозг [target.current.real_name], он нам пригодитс&#255;."
		else
			explanation_text = "Ты свободен."
		return target
...
datum/objective/hijack
	explanation_text = "Улети на эвакуционном шаттле САМ."
...
datum/objective/block
	explanation_text = "Не дай им сбежать со станции."
...
datum/objective/escape
	explanation_text = "Улети со станции на эвакуционном шаттле."
...
datum/objective/nuclear
	explanation_text = "Уничтожь станцию &#255;дерным взрывом."
...
datum/objective/steal
	...
	proc/set_target(item_name)
		...
		explanation_text = "Укради [target_name]."
		return steal_target
