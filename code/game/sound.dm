/proc/playsound(var/atom/source, soundin, vol as num, vary, extrarange as num)
	...
	switch(soundin)
		...
		if ("step") soundin = pick('sound/effects/step1.ogg','sound/effects/step2.ogg','sound/effects/step3.ogg')
...
/area/Entered(A)
	...
	if (ismob(A))
		...
		if(istype(src, /area))
			sound = pick('sound/ambience/shipambience1.ogg','sound/ambience/shipambience2.ogg','sound/ambience/shipambience3.ogg')
/*
		switch(src.name)
