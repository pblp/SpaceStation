...
/obj/bmode/buildhelp
	...
	Click()
		switch(master.cl.buildmode)
			...
			if(4)
				usr << "\blue ***********************************************************"
				usr << "\blue Left Mouse Button on turf/obj/mob      = throwing"
...
/obj/bmode/buildholder
	...
	var/atom/movable/throwing_atom = null
...
/proc/build_click(var/mob/user, buildmode, location, control, params, var/obj/object)
	...
	switch(buildmode)
		...
		if(4)
			if(pa.Find("left"))
				holder.throwing_atom = object
			if(pa.Find("right"))
				if(holder.throwing_atom)
					holder.throwing_atom.throwing_at(object, 10, 1)
